...
public static class EnemyUtil {
    ...
    public static readonly Dictionary<string, string> nameDict = new() {
        ...
        {"Monster8", "免疫冰冻,减少50%冰系伤害,受到额外50%火系伤害"},
        {"Monster9", "免疫麻痹,冰冻,阻挡弹道,难以击退"},
        {"Monster10", "免疫减速,受到额外50%火系伤害,死亡后加速身边怪物50%,持续2s"},
        {"Monster11", "免疫眩晕,减少50%弹道伤害,较难击退"},
        {"Monster12", "首次到达50%血量时,获得无敌冲刺2s(免疫不良状态和伤害),接近防线时无效,攻击两次,受到额外50%元素伤害"},
        ...
        {"Boss6", "免疫元素伤害,免疫冰冻,麻痹,受到50%物理伤害"}
    };
